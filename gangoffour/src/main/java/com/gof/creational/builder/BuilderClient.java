 ...
 * 
 */
import com.gof.creational.builder.impl.ConcreteBuilderA;

public final class BuilderClient {
	
	public static void main (String args[]) {
				
		System.out.println("in BuilderClient main...");
		AbstractBuilder builder = new ConcreteBuilderA();
		Director d = new Director(builder);
		
		d.materialiseABuiltProduct();
		
		((ConcreteBuilderA)builder).getBuiltProduct().toString();
